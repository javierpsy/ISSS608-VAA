...
## 4.5.1 Additional Analysis 1 - Population Growth Rate Analysis
**Objective:**
To analyse how population has grown over time across different countries or regions in order to identify long-term growth patterns.
...
ggplot(pop_data,
  ...
  geom_line() +
  labs(
    title = "Population Growth Trend by Country",
    x = "Year",
    y = "Population"
  ) +
  theme_minimal()
...
**Insights:** The line chart reveals the population growth trends across countries over time. Countries such as China and India exhibit steep upward trends, indicating rapid population growth over the years.

## 4.5.2 Additional Analysis 2 - Population Distribution by Region
**Objective:**
To examine how population sizes vary across different regions and identify regions with large variability in population.
...
ggplot(pop_data,
  ...
  geom_boxplot() +
  labs(
    title = "Population Distribution Across Regions",
    x = "Region",
    y = "Population"
  ) +
  theme_minimal()
...
**Insights:** The boxplot shows clear differences in population distribution across regions. Asia has the highest median population and the widest variability, largely driven by highly populated countries such as China and India.

## 4.5.3 Additional Analysis 3 - Population vs Life Expectancy Relationship
**Objective:** To investigate whether countries with larger populations tend to have different life expectancy levels.
...
**Insights:** The scatterplot indicates that there is no strong direct relationship between population size and life expectancy. Countries with large populations do not necessarily have higher or lower life expectancy.
