...
By the end of this hands-on exercise we can create the followings data visualisation by using R packages:
...
In this section, we will learn how to plot a calender heatmap by using ggplot2 package

![](Calendar%20Heatmap.png){width="686"}
...
![](Data%20Structure1.png){width="717"}
...
![](Data%20Structure2.png){width="691"}
...
![](Data%20Structure3.png)

In this case, we can group the count by hour and wkday and plot it, since we know that we have values for every combination there's no need to further preprocess the data.

### 17.4.6 Building Multiple Calendar Heatmaps

**Challenge**: Building multiple heatmaps for the top four countries with the highest number of attacks.

![](Data%20Structure4.png)
...
![](17.5%20Plotting%20Cycle%20Plot.png)
