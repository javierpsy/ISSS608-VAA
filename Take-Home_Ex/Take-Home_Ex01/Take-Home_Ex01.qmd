...
-   Comprehensive insurance products exhibitedthe highest underwriting and profitability challenges throughout the portfolio. Comprehensive without Excess showed the highest average claim cost (600), highest loss ratio (93.9%), and highest underpricing rate (20.8%), suggesting that claim expenses almost consumed the premiums garnered and put the portfolio at increased financial risk.

-   Temporal portfolio analysis revealed increasing underwriting pressure between 2022 and 2024. The year 2022 demonstrated the strongest portfolio performance with the lowest claim rate (13.0%), lowest loss ratio (65.6%), and lowest underpricing rate (8.0%). By 2024, claim rate increased to 15.1%, underpricing rate rose to 9.7%, and loss ratio reached 74.7%, indicating growing profitability pressure and rising claim costs over time.

-   Analysis of vehicle value segmentation showed significant variations in the distributions of claim severity. Vehicles with higher values exhibited broader severity variation, more pronounced upper-tail behavior, and heightened volatility in incurred losses, signifying a greater risk of costly and financially significant claims. This implies that vehicle valuation continues to be an essential factor in assessing portfolio risk during underwriting.
...
-   Correlation analysis showed that most portfolio variables each displayed relatively weak direct associations with claim severity and profitability metrics. Apart from the naturally strong association between driver age and driving experience, most underwriting indicators demonstrated low-to-moderate pairwise correlations, suggesting that motor insurance risk is likely influenced by complex interactions among multiple behavioural, pricing, exposure, and operational dimensions rather than a single dominant predictor.
...
**Predictive Analytics and Machine Learning:** Future research could investigate predictive modeling techniques like logistic regression, random forests, gradient boosting, or survival analysis to determine if multivariate underwriting variables can enhance the accuracy of predictions related to claim occurrence, claim severity, or underpricing behavior.
