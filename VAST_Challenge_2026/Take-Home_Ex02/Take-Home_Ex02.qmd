...
### Hourly Communication Distribution Across Breach Windows

```{r}
communication_hourly <- communications_clean %>%
  count(
    near_breach_window,
    communication_hour
  )
...
ggplot(
  ...
  aes(
    x = communication_hour,
    y = n,
    group = near_breach_window,
    colour = near_breach_window
  )
) +
  ...
  facet_wrap(~ near_breach_window) +
  
  labs(
    title = "Hourly Communication Distribution Across Breach Windows",
    subtitle = "Comparing communication timing before the embargo breach",
    x = "Hour of Day",
    y = "Number of Communications",
    colour = "Breach Window"
  ) +
  
  theme_minimal()
```

The hourly heatmap highlights when communication activity was most concentrated. This helps identify whether communication behaviour was clustered within specific time windows prior to the embargo breach.
