...
ggraph(
  ...
  theme_void() +
  labs(
    title = "Phrase Relationships Among Critical-period Communication Topics",
    subtitle = "Directed bigram network constructed from recurring word pairs during the Critical Period"
  ) +
  theme(
    plot.title = element_text(face = "bold")
  )
...
-   During the Critical Period, communications became more focused on governance, access management, auditing, and public communication themes, indicating a move away from regular operational discussions towards issues more connected to organisational oversight and information regulation.

-   The frequent occurrence of phrase relationships such as **access controls**, **role based**, **governance reforms**, and **independent audit** signifies increased focus on governance and accountability structures during the days leading up to the inappropriate release.

-   The recurring phrase **press release** suggests that public communication activities were already being actively discussed prior to the breach event, indicating that these release-related activities were not limited to one communication or individual.
...
-   In general, these recurring phrase connections imply that the improper release was foreshadowed by a communication context marked by governance dialogues, planning related to the release, and heightened focus on oversight procedures, indicating possible leading signs prior to the embargo breach.
