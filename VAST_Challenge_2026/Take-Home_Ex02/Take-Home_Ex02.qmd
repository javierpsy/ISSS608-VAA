...
The node table illustrates the participants involved in communication within the simulation environment, whereas the edge table records the directional relationships between senders and receivers through various communication channels.

```{r}
communication_nodes <- communications_clean %>%
...
The structure of the communication nodes can be examined below.
...
The weighted communication edges are verified below.
