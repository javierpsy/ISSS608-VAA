...
The increasing prominence of governance-, trust-, and public communication-related themes is broadly consistent with crisis communication research, which suggests that discussions often become more focused on accountability, trust, and public response during periods of organisational uncertainty (Abd Elfattah, 2024).
...
In summary, the evidence suggests that the inappropriate release was preceded by a gradual escalation of communication risk rather than a single isolated failure. Changes in participant behaviour, communication pathways, and discussion topics collectively created conditions that increased the likelihood of embargo-sensitive information progressing towards public disclosure. These findings are broadly aligned with prior research demonstrating that communication networks often exhibit changes in structure, participant behaviour, and information flow patterns before major organisational events [(Wen et al., 2024.)](https://www.sciencedirect.com/science/article/pii/S0306457324002863?via%3Dihub)
...
Chapter 27: Modelling, Visualising and Analysing Network Data with R – R for Visual Analytics. (n.d.). Retrieved from <https://r4va.netlify.app/chap27>

Chapter 29: Visualising and Analysing Text Data with R: tidytext methods – R for Visual Analytics. (n.d.). Retrieved from <https://r4va.netlify.app/chap29>
